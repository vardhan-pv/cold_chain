#pragma once
#include <Arduino.h>
// Final BOM baseline: no pressure, vibration, relay, switched fan, or backup-current sensor.
// No GPIO number is guessed. Copy commissioning.example.h to commissioning.h after board review.
...
// Optional peripherals excluded from required base build.
...
// Fan has no software switch or tachometer in the final BOM. Wire to protected unswitched 12 V.
